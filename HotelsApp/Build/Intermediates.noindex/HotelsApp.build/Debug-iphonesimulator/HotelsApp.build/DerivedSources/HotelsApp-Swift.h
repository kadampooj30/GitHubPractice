...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HotelsApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9HotelsApp11AppDelegate")
...
SWIFT_CLASS("_TtC9HotelsApp13SceneDelegate")
...
SWIFT_CLASS("_TtC9HotelsApp14ViewController")
